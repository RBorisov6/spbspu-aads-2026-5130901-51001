...
void borisov::cmdPrint(std::istream& in, std::ostream& out, borisov::DataTable& table)
{
  std::string name;
...
void borisov::cmdComplement(std::istream& in, std::ostream& out, borisov::DataTable& table)
{
  std::string newName;
  std::string name1;
  std::string name2;
...
void borisov::cmdIntersect(std::istream& in, std::ostream& out, borisov::DataTable& table)
{
  std::string newName;
  std::string name1;
  std::string name2;
...
void borisov::cmdUnion(std::istream& in, std::ostream& out, borisov::DataTable& table)
{
  std::string newName;
  std::string name1;
  std::string name2;
...
void borisov::executeCommand(const std::string& line, borisov::DataTable& table, std::ostream& out)
{
